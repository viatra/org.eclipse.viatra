 ...
 * 
 */
class ViewersDebuggerUI implements IDebuggerUI{
	...
	static class DebuggerUI implements Runnable{
		...
		Text activationText
		ViewersDebuggerUI parent
		public boolean initialized = false
		
		new(IncQueryEngine engine, Set<IQuerySpecification<?>> queries, ViewersDebuggerUI parent){
			this.engine = engine
			this.queries = queries
			this.parent = parent
		}
