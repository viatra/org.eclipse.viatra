...
public interface ExistenceJoinRecipe extends BetaRecipe
{
   ...
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipse.incquery.runtime.rete.recipes.ProjectionIndexerRecipe%> _leftParent = this.getLeftParent();\nreturn _leftParent.getArity();'"
   * @generated
   */
  int getArity();
