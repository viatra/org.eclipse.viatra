...
@parser::members {
    ...
    public InternalIncQueryXcoreParser(TokenStream input, IncQueryXcoreGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected IncQueryXcoreGrammarAccess getGrammarAccess() {
...
entryRuleXIncQueryPackage returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXIncQueryPackageRule()); }
	 iv_ruleXIncQueryPackage=ruleXIncQueryPackage 
	 { $current=$iv_ruleXIncQueryPackage.current; } 
	 EOF 
;

// Rule XIncQueryPackage
ruleXIncQueryPackage returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getXIncQueryPackageAccess().getXIncQueryPackageAction_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryPackageAccess().getAnnotationsXAnnotationParserRuleCall_1_0()); 
	    }
		lv_annotations_1_0=ruleXAnnotation		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getXIncQueryPackageRule());
	        }
       		add(
       			$current, 
       			"annotations",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getXIncQueryPackageAccess().getPackageKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryPackageAccess().getNameQualifiedNameParserRuleCall_3_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryPackageAccess().getImportDirectivesXImportDirectiveParserRuleCall_4_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryPackageAccess().getImportedIncQueriesXIncQueryImportParserRuleCall_5_0()); 
	    }
		lv_importedIncQueries_5_0=ruleXIncQueryImport		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getXIncQueryPackageRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryPackageAccess().getAnnotationDirectivesXAnnotationDirectiveParserRuleCall_6_0()); 
	    }
		lv_annotationDirectives_6_0=ruleXAnnotationDirective		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getXIncQueryPackageRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryPackageAccess().getClassifiersXClassifierParserRuleCall_7_0()); 
	    }
		lv_classifiers_7_0=ruleXClassifier		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getXIncQueryPackageRule());
	        }
       		add(
...
entryRuleXIncQueryImport returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXIncQueryImportRule()); }
	 iv_ruleXIncQueryImport=ruleXIncQueryImport 
	 { $current=$iv_ruleXIncQueryImport.current; } 
	 EOF 
;

// Rule XIncQueryImport
ruleXIncQueryImport returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='import-incqueries' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getXIncQueryImportAccess().getImportIncqueriesKeyword_0());
    }
(
(
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getXIncQueryImportRule());
	        }
        }
	otherlv_1=RULE_STRING
	{
		newLeafNode(otherlv_1, grammarAccess.getXIncQueryImportAccess().getImportedPatternModelPatternModelCrossReference_1_0()); 
	}

)
)(	otherlv_2=';' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getXIncQueryImportAccess().getSemicolonKeyword_2());
    }
)?)
;
...
(
    ...
    |
    { 
        newCompositeNode(grammarAccess.getXMemberAccess().getXIncQueryDerivedFeatureParserRuleCall_3()); 
    }
    this_XIncQueryDerivedFeature_3=ruleXIncQueryDerivedFeature
    { 
        $current = $this_XIncQueryDerivedFeature_3.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleXIncQueryDerivedFeature returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXIncQueryDerivedFeatureRule()); }
	 iv_ruleXIncQueryDerivedFeature=ruleXIncQueryDerivedFeature 
	 { $current=$iv_ruleXIncQueryDerivedFeature.current; } 
	 EOF 
;

// Rule XIncQueryDerivedFeature
ruleXIncQueryDerivedFeature returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getXIncQueryDerivedFeatureAccess().getXIncQueryDerivedFeatureAction_0(),
            $current);
    }
)	otherlv_1='incquery-derived' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getXIncQueryDerivedFeatureAccess().getIncqueryDerivedKeyword_1());
    }
(
(
		lv_reference_2_0=	'refers' 
    {
        newLeafNode(lv_reference_2_0, grammarAccess.getXIncQueryDerivedFeatureAccess().getReferenceRefersKeyword_2_0());
    }
 
	    {
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getXIncQueryDerivedFeatureRule());
	        }
       		setWithLastConsumed($current, "reference", true, "refers");
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryDerivedFeatureAccess().getTypeXGenericTypeParserRuleCall_3_0()); 
	    }
		lv_type_3_0=ruleXGenericType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getXIncQueryDerivedFeatureRule());
	        }
       		set(
       			$current, 
       			"type",
...
(
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryDerivedFeatureAccess().getMultiplicityXMultiplicityParserRuleCall_4_0()); 
	    }
		lv_multiplicity_4_0=ruleXMultiplicity		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getXIncQueryDerivedFeatureRule());
	        }
       		set(
...
(
		lv_name_5_0=RULE_ID
		{
			newLeafNode(lv_name_5_0, grammarAccess.getXIncQueryDerivedFeatureAccess().getNameIDTerminalRuleCall_5_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getXIncQueryDerivedFeatureRule());
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getXIncQueryDerivedFeatureAccess().getSpecKeyword_6());
    }
(
(
		{
		...
		{ 
	        newCompositeNode(grammarAccess.getXIncQueryDerivedFeatureAccess().getPatternPatternCrossReference_7_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getXIncQueryDerivedFeatureAccess().getSemicolonKeyword_8());
    }
)?)
;
