...
/**
 * Manual modifications go to {org.eclipse.incquery.xcore.IncQueryXcoreRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractIncQueryXcoreRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/incquery/xcore/IncQueryXcore.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.incquery.xcore.IncQueryXcore");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("xcoreiq");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.eclipse.incquery.xcore.services.IncQueryXcoreGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.eclipse.incquery.xcore.parser.antlr.IncQueryXcoreParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.eclipse.incquery.xcore.parser.antlr.IncQueryXcoreAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.eclipse.incquery.xcore.parser.antlr.internal.InternalIncQueryXcoreLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.eclipse.incquery.xcore.parser.antlr.internal.InternalIncQueryXcoreLexer> provideInternalIncQueryXcoreLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.eclipse.incquery.xcore.parser.antlr.internal.InternalIncQueryXcoreLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.eclipse.incquery.xcore.parser.antlr.internal.InternalIncQueryXcoreLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.eclipse.incquery.xcore.validation.IncQueryXcoreJavaValidator> bindIncQueryXcoreJavaValidator() {
		return org.eclipse.incquery.xcore.validation.IncQueryXcoreJavaValidator.class;
	}
