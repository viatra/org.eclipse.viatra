 ...
 *
 */
public class MWE2ControllableAdapterSupportingExecutor extends MWE2ControllableExecutor implements IController{
    protected List<ITransformationAdapter> adapters;
       
    
    public MWE2ControllableAdapterSupportingExecutor(EventRealm eventRealm) {
        super(eventRealm);
    }
    
    public MWE2ControllableAdapterSupportingExecutor(EventRealm eventRealm, List<ITransformationAdapter> adapters) {
        super(eventRealm);
        this.adapters = adapters;
    }
    
    public MWE2ControllableAdapterSupportingExecutor(EventRealm eventRealm, Context context){
        super(eventRealm, context);
    }
    
    public MWE2ControllableAdapterSupportingExecutor(EventRealm eventRealm, Context context, List<ITransformationAdapter> adapters){
        super(eventRealm, context);
        this.adapters = adapters;
    }
