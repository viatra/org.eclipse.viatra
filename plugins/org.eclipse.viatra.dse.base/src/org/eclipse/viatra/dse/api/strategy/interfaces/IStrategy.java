 ...
 * exploration strategy. It is currently unfinished, and the implementation {@link Strategy} is currently hard wired
 * into the {@link DesignSpaceExplorer}.
 * 
 * Possible future implementation will provide a means to specify a custom {@link IStrategy}.
 * 
...
public interface IStrategy extends Runnable {
    ...
    /**
     * Signals the {@link IStrategy} instance that execution should be stopped. By contract, the strategy is to stop
