...
/**
 * 
 * Checks all global constraints. If a constraint is not satisfied, it will mark the state as a CUT state, hence it
 ...
 * 
 */
public class CheckAllConstraints implements ICheckConstraints {
