 ...
 */
public class NonDelegatingXbaseScopeProvider extends AbstractScopeProvider {
	...
	private final static Logger log = Logger.getLogger(NonDelegatingXbaseScopeProvider.class);
	...
	protected IScope createConstructorCallScope(final EObject context, EReference reference) {
		final IScope scope = IScope.NULLSCOPE;
		return new IScope() {
