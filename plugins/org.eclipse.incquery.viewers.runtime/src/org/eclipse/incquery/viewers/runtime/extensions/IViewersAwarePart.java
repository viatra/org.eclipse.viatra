 ...
 *
 */
public interface IViewersAwarePart {

	/**
	 * Access to the {@link Notifier} which will represent the EMF instance model to be visualized by
	 * IncQuery Viewers supported components.
	 */
