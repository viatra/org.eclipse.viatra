...
import org.eclipse.viatra.cep.vepl.vepl.Expression
import org.eclipse.viatra.cep.vepl.vepl.FollowsExpression
import org.eclipse.viatra.cep.vepl.vepl.IQPatternEventPattern
import org.eclipse.viatra.cep.vepl.vepl.ModelElement
import org.eclipse.viatra.cep.vepl.vepl.MultiplicityExpression
import org.eclipse.viatra.cep.vepl.vepl.NegExpression
import org.eclipse.viatra.cep.vepl.vepl.OrExpression
import org.eclipse.viatra.cep.vepl.vepl.PatternCallParameter
import org.eclipse.viatra.cep.vepl.vepl.Rule
import org.eclipse.viatra.cep.vepl.vepl.TimedExpression
import org.eclipse.viatra.cep.vepl.vepl.TimedMultiplicityExpression
import org.eclipse.viatra.cep.vepl.vepl.UntilExpression
...
class Utils {
	...
	def dispatch getComplexOperator(OrExpression expression) {
		return "createOR()"
	}
	
	def dispatch getComplexOperator(UntilExpression expression) {
		return "createUNTIL()"
	}
	
	def dispatch getComplexOperator(NegExpression expression) {
		return "createNEG()"
	}
	...
	def dispatch getAssignedEventPatterns(OrExpression expression) {
		var eventPatterns = newArrayList()
