...
* generated by Xtext
*/
package org.eclipse.incquery.xcore.ui.contentassist.antlr;
...
public class IncQueryXcoreParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.incquery.xcore.ui.contentassist.antlr.internal.InternalIncQueryXcoreParser createParser() {
		org.eclipse.incquery.xcore.ui.contentassist.antlr.internal.InternalIncQueryXcoreParser result = new org.eclipse.incquery.xcore.ui.contentassist.antlr.internal.InternalIncQueryXcoreParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXIncQueryPackageAccess().getGroup(), "rule__XIncQueryPackage__Group__0");
					put(grammarAccess.getXIncQueryImportAccess().getGroup(), "rule__XIncQueryImport__Group__0");
					put(grammarAccess.getXIncQueryDerivedFeatureAccess().getGroup(), "rule__XIncQueryDerivedFeature__Group__0");
					...
					put(grammarAccess.getXIncQueryPackageAccess().getAnnotationsAssignment_1(), "rule__XIncQueryPackage__AnnotationsAssignment_1");
					put(grammarAccess.getXIncQueryPackageAccess().getNameAssignment_3(), "rule__XIncQueryPackage__NameAssignment_3");
					put(grammarAccess.getXIncQueryPackageAccess().getImportDirectivesAssignment_4(), "rule__XIncQueryPackage__ImportDirectivesAssignment_4");
					put(grammarAccess.getXIncQueryPackageAccess().getImportedIncQueriesAssignment_5(), "rule__XIncQueryPackage__ImportedIncQueriesAssignment_5");
					put(grammarAccess.getXIncQueryPackageAccess().getAnnotationDirectivesAssignment_6(), "rule__XIncQueryPackage__AnnotationDirectivesAssignment_6");
					put(grammarAccess.getXIncQueryPackageAccess().getClassifiersAssignment_7(), "rule__XIncQueryPackage__ClassifiersAssignment_7");
					put(grammarAccess.getXIncQueryImportAccess().getImportedPatternModelAssignment_1(), "rule__XIncQueryImport__ImportedPatternModelAssignment_1");
					put(grammarAccess.getXIncQueryDerivedFeatureAccess().getReferenceAssignment_2(), "rule__XIncQueryDerivedFeature__ReferenceAssignment_2");
					put(grammarAccess.getXIncQueryDerivedFeatureAccess().getTypeAssignment_3(), "rule__XIncQueryDerivedFeature__TypeAssignment_3");
					put(grammarAccess.getXIncQueryDerivedFeatureAccess().getMultiplicityAssignment_4(), "rule__XIncQueryDerivedFeature__MultiplicityAssignment_4");
					put(grammarAccess.getXIncQueryDerivedFeatureAccess().getNameAssignment_5(), "rule__XIncQueryDerivedFeature__NameAssignment_5");
					put(grammarAccess.getXIncQueryDerivedFeatureAccess().getPatternAssignment_7(), "rule__XIncQueryDerivedFeature__PatternAssignment_7");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.incquery.xcore.ui.contentassist.antlr.internal.InternalIncQueryXcoreParser typedParser = (org.eclipse.incquery.xcore.ui.contentassist.antlr.internal.InternalIncQueryXcoreParser) parser;
			typedParser.entryRuleXIncQueryPackage();
