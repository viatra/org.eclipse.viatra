...
public class IncQueryXcoreUiModule extends org.eclipse.incquery.xcore.ui.AbstractIncQueryXcoreUiModule {
    public IncQueryXcoreUiModule(AbstractUIPlugin plugin) {
        super(plugin);
    }
