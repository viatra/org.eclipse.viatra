...
/**
 * GMF-specific loader class that initializes the IncQuery UI for the resource of the business model.
 * @author istvanrath
 *
 */
public class GMFEditorLoadResourceHandler extends LoadModelHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
            ...
            // TODO also support IDiagramWorkbenchPart
        {
            ...
            Resource resource = ((EObject)editor.getDiagramEditPart().getModel()).eResource();
            if (resource!=null) {
