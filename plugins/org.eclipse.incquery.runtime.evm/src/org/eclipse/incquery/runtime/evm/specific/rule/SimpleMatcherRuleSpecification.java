...
public class SimpleMatcherRuleSpecification<Match extends IPatternMatch> extends RuleSpecification {
    ...
    private final IQuerySpecification<? extends IncQueryMatcher<Match>> querySpecification;
     ...
     * @param jobs
     */
    public SimpleMatcherRuleSpecification(final IQuerySpecification<? extends IncQueryMatcher<Match>> querySpecification, final ActivationLifeCycle lifeCycle,
