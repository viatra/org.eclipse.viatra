 ...
 * 
 */
public class InitializeViewersHandlerResourceSet extends AbstractHandler {
                ...
                if (editorPart instanceof IEditingDomainProvider) {
                    ...
                    if (resourceSet.getResources().size() > 0) {
                        ...
                        if (ViewerSandboxView.getInstance() != null) {
                            ...
                            ViewerSandboxView.getInstance().setContents(emc.getNotifier(IModelConnectorTypeEnum.RESOURCESET), patterns, filter);
                        }
                    }
                }
