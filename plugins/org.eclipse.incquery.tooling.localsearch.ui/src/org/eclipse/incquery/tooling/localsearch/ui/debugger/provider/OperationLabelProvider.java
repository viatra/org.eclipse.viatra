...
public class OperationLabelProvider extends StyledCellLabelProvider {
    ...
    public OperationLabelProvider(List<ISearchOperation> breakpoints) {
    ...
    public void update(ViewerCell cell) {
        ...
        text.append(operation.getClass().toString().substring(operation.getClass().toString().lastIndexOf('.') + 1));
        if (operation instanceof IterateOverEClassInstances) {
            IterateOverEClassInstances ioeci = (IterateOverEClassInstances) operation;
    ...
    public void setPlanExecutor(SearchPlanExecutor planExecutor) {
