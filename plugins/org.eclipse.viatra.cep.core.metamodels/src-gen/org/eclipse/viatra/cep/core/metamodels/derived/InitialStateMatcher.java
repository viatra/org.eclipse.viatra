...
public class InitialStateMatcher extends BaseMatcher<InitialStateMatch> {
   ...
   * 
   */
  public static InitialStateMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    InitialStateMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new InitialStateMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(InitialStateMatcher.class);
   ...
   */
  @Deprecated
  public InitialStateMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public InitialStateMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected InitialStateMatch tupleToMatch(final Tuple t) {
    try {
    	return InitialStateMatch.newMatch((org.eclipse.viatra.cep.core.metamodels.automaton.Automaton) t.get(POSITION_THIS), (org.eclipse.viatra.cep.core.metamodels.automaton.InitState) t.get(POSITION_INITSTATE));
  ...
  protected InitialStateMatch arrayToMatch(final Object[] match) {
    try {
    	return InitialStateMatch.newMatch((org.eclipse.viatra.cep.core.metamodels.automaton.Automaton) match[POSITION_THIS], (org.eclipse.viatra.cep.core.metamodels.automaton.InitState) match[POSITION_INITSTATE]);
    } catch(ClassCastException e) {
  ...
  protected InitialStateMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return InitialStateMatch.newMutableMatch((org.eclipse.viatra.cep.core.metamodels.automaton.Automaton) match[POSITION_THIS], (org.eclipse.viatra.cep.core.metamodels.automaton.InitState) match[POSITION_INITSTATE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<InitialStateMatcher> querySpecification() throws IncQueryException {
