 ...
 * <ul>
 *   <li>{@link org.eclipse.viatra.cep.core.metamodels.events.impl.EventPatternImpl#getAutomaton <em>Automaton</em>}</li>
 *   <li>{@link org.eclipse.viatra.cep.core.metamodels.events.impl.EventPatternImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class EventPatternImpl extends MinimalEObjectImpl.Container implements EventPattern {
    /**
    ...
    protected EClass eStaticClass() {
        return EventsPackage.Literals.EVENT_PATTERN;
    }
        ...
        if (automaton != null && automaton.eIsProxy()) {
            ...
            if (automaton != oldAutomaton) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventsPackage.EVENT_PATTERN__AUTOMATON, oldAutomaton, automaton));
            }
        }
        return automaton;
    }
    ...
    public NotificationChain basicSetAutomaton(Automaton newAutomaton, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EventsPackage.EVENT_PATTERN__AUTOMATON, oldAutomaton, newAutomaton);
    ...
    public void setAutomaton(Automaton newAutomaton) {
        if (newAutomaton != automaton) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.EVENT_PATTERN__AUTOMATON, newAutomaton, newAutomaton));
    }
    ...
    public void setId(String newId) {
        ...
        id = newId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.EVENT_PATTERN__ID, oldId, id));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EventsPackage.EVENT_PATTERN__AUTOMATON:
                if (automaton != null)
                    msgs = ((InternalEObject)automaton).eInverseRemove(this, AutomatonPackage.AUTOMATON__EVENT_PATTERN, Automaton.class, msgs);
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case EventsPackage.EVENT_PATTERN__ID:
                return getId();
        }
