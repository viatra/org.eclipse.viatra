 ...
 * <ul>
 *   <li>{@link org.eclipse.viatra.cep.core.metamodels.events.impl.AtomicEventPatternImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AtomicEventPatternImpl extends EventPatternImpl implements AtomicEventPattern {
    ...
    public void setType(String newType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.ATOMIC_EVENT_PATTERN__TYPE, oldType, type));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EventsPackage.ATOMIC_EVENT_PATTERN__TYPE:
                return getType();
        }
