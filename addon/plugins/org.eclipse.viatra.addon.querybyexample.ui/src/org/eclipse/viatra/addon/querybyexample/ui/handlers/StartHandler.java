...
public class StartHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (selectedEObjects == null || selectedEObjects.isEmpty()) {
            MessageDialog.openError(HandlerUtil.getActiveShell(event), StartHandler.QBE_COMMON_ALERT_TITLE,
                    StartHandler.QBE_NO_EOBJECTS_IN_SELECTION_ERROR);
            return null;
        }
        qbeView.activateView(selectedEObjects);
