 ...
 *     Zoltan Ujhelyi <ujhelyiz@incquerylabs.com> - Copied to VIATRA for backwards compatibility with pre-Java 8 versions
 *******************************************************************************/
 ...
 * </p>
 * <p>
 * Copied from JFace Data binding, see bug 492683 for details.
 * </p>
 * <p>
...
abstract class ComputedValue/*<T>*/ extends AbstractObservableValue/*<T>*/ {

	private boolean dirty = true;

	private boolean stale = false;

	private Object/*T*/ cachedValue = null;
	...
	@Override
	protected final /*T*/Object doGetValue() {
		if (dirty) {
	 ...
	 */
	protected abstract /*T*/ Object calculate();
	...
	protected final void makeDirty() {
		if (!dirty) {
			...
			// copy the old value
			final /*T*/Object oldValue = cachedValue;
			// Fire the "dirty" event. This implementation recomputes the new
			// value lazily.
			fireValueChange(new ValueDiff/*<T>*/() {

				@Override
				public /*T*/Object getOldValue() {
					return oldValue;
				}

				@Override
				public /*T*/Object getNewValue() {
					return getValue();
				}
			});
		}
