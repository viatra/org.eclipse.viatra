...
/**
 * A violation key serves as an object to uniquely identify a set of String - Object pairs with the possibility of
 * symmetric equivalence relationships between pairs.
 * 
 * @author Balint Lorand
 *
 */
public interface ViolationKey {
