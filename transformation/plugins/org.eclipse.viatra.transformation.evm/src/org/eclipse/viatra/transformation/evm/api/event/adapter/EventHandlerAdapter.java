...
public abstract class EventHandlerAdapter<EventAtom> implements EventHandler<EventAtom> {
    ...
    protected EventHandlerAdapter(EventSource<EventAtom> source, EventFilter<? super EventAtom> filter, RuleInstance<EventAtom> instance) {
        Preconditions.checkArgument(source != null, "Cannot create handler with null source");
        Preconditions.checkArgument(filter != null, "Cannot create handler with null filter");
        Preconditions.checkArgument(instance != null, "Cannot create handler with null instance");
    ...
    protected void prepareEventHandler() {
        processors = Objects.requireNonNull(prepareEventProcessors(), "Prepared event processor map was null!");
