...
public interface IModelManipulations {
    ...
    /**
     * Creates an EObject and puts it into the selected reference of a container. The container reference must be a
    ...
    void addTo(EObject container, EStructuralFeature reference, Collection<? extends Object> element)
            throws ModelManipulationException;
     ...
     */
    void remove(EObject container, EReference reference, EObject element) throws ModelManipulationException;
