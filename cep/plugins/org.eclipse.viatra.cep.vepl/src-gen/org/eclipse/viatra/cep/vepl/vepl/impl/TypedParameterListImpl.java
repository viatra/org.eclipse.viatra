 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.cep.vepl.vepl.impl.TypedParameterListImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypedParameterListImpl extends MinimalEObjectImpl.Container implements TypedParameterList
{
  ...
  {
    return VeplPackage.Literals.TYPED_PARAMETER_LIST;
  }
  ...
  public EList<TypedParameter> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<TypedParameter>(TypedParameter.class, this, VeplPackage.TYPED_PARAMETER_LIST__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case VeplPackage.TYPED_PARAMETER_LIST__PARAMETERS:
