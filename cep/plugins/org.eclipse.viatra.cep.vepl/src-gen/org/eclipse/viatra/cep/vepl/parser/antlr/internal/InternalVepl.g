...
(
    ...
    { 
        $current = $this_GenericImport_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_QueryImport_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleQueryImport returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getQueryImportRule()); }
	 iv_ruleQueryImport=ruleQueryImport 
	 { $current=$iv_ruleQueryImport.current; } 
	 EOF 
;

// Rule QueryImport
ruleQueryImport returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='import-queries' 
    {
...
(
    ...
    { 
        $current = $this_QueryResultChangeEventPattern_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleQueryResultChangeEventPattern returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getQueryResultChangeEventPatternRule()); }
	 ...
	 { $current=$iv_ruleQueryResultChangeEventPattern.current; } 
	 EOF 
;

// Rule QueryResultChangeEventPattern
ruleQueryResultChangeEventPattern returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='queryEvent' 
    {
...
entryRuleTraitList returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTraitListRule()); }
	 iv_ruleTraitList=ruleTraitList 
	 { $current=$iv_ruleTraitList.current; } 
	 EOF 
;

// Rule TraitList
ruleTraitList returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleTypedParameterWithDefaultValue returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTypedParameterWithDefaultValueRule()); }
	 ...
	 { $current=$iv_ruleTypedParameterWithDefaultValue.current; } 
	 EOF 
;

// Rule TypedParameterWithDefaultValue
ruleTypedParameterWithDefaultValue returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleTraitTypedParameterList returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTraitTypedParameterListRule()); }
	 iv_ruleTraitTypedParameterList=ruleTraitTypedParameterList 
	 { $current=$iv_ruleTraitTypedParameterList.current; } 
	 EOF 
;

// Rule TraitTypedParameterList
ruleTraitTypedParameterList returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleParametrizedQueryReference returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getParametrizedQueryReferenceRule()); }
	 ...
	 { $current=$iv_ruleParametrizedQueryReference.current; } 
	 EOF 
;

// Rule ParametrizedQueryReference
ruleParametrizedQueryReference returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    { 
        $current = $this_NormalPrimary_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_NegatedPrimary_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleNormalPrimary returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNormalPrimaryRule()); }
	 iv_ruleNormalPrimary=ruleNormalPrimary 
	 { $current=$iv_ruleNormalPrimary.current; } 
	 EOF 
;

// Rule NormalPrimary
ruleNormalPrimary returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    { 
        $current = $this_ComplexEventExpression_4.current; 
        afterParserOrEnumRuleCall();
    }
	otherlv_5=')' 
    {
...
entryRuleNegatedPrimary returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNegatedPrimaryRule()); }
	 iv_ruleNegatedPrimary=ruleNegatedPrimary 
	 { $current=$iv_ruleNegatedPrimary.current; } 
	 EOF 
;

// Rule NegatedPrimary
ruleNegatedPrimary returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleAbstractMultiplicity returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAbstractMultiplicityRule()); }
	 iv_ruleAbstractMultiplicity=ruleAbstractMultiplicity 
	 { $current=$iv_ruleAbstractMultiplicity.current; } 
	 EOF 
;

// Rule AbstractMultiplicity
ruleAbstractMultiplicity returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_Multiplicity_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_Infinite_1.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleInfinite returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getInfiniteRule()); }
	 iv_ruleInfinite=ruleInfinite 
	 { $current=$iv_ruleInfinite.current; } 
	 EOF 
;

// Rule Infinite
ruleInfinite returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleParameterizedPatternCall returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getParameterizedPatternCallRule()); }
	 ...
	 { $current=$iv_ruleParameterizedPatternCall.current; } 
	 EOF 
;

// Rule ParameterizedPatternCall
ruleParameterizedPatternCall returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    { 
        $current = $this_FollowsOperator_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_OrOperator_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_AndOperator_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
ruleUnaryOperator returns [EObject current=null] 
    ...
    { 
        $current = $this_NegOperator_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleNegOperator returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNegOperatorRule()); }
	 iv_ruleNegOperator=ruleNegOperator 
	 { $current=$iv_ruleNegOperator.current; } 
	 EOF 
;

// Rule NegOperator
ruleNegOperator returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
ruleQueryResultChangeType returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
((	enumLiteral_0='found' 
	{
