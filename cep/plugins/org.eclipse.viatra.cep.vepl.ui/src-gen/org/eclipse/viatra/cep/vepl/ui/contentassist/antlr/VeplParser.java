 ...
 * generated by Xtext
 */
package org.eclipse.viatra.cep.vepl.ui.contentassist.antlr;
...
public class VeplParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.viatra.cep.vepl.ui.contentassist.antlr.internal.InternalVeplParser createParser() {
		org.eclipse.viatra.cep.vepl.ui.contentassist.antlr.internal.InternalVeplParser result = new org.eclipse.viatra.cep.vepl.ui.contentassist.antlr.internal.InternalVeplParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNormalPrimaryAccess().getAlternatives(), "rule__NormalPrimary__Alternatives");
					put(grammarAccess.getAbstractMultiplicityAccess().getAlternatives(), "rule__AbstractMultiplicity__Alternatives");
					put(grammarAccess.getComplexEventOperatorAccess().getAlternatives(), "rule__ComplexEventOperator__Alternatives");
					...
					put(grammarAccess.getContextEnumAccess().getAlternatives(), "rule__ContextEnum__Alternatives");
					put(grammarAccess.getContextAccess().getAlternatives(), "rule__Context__Alternatives");
					put(grammarAccess.getQueryResultChangeTypeAccess().getAlternatives(), "rule__QueryResultChangeType__Alternatives");
					put(grammarAccess.getEventModelAccess().getGroup(), "rule__EventModel__Group__0");
					put(grammarAccess.getEventModelAccess().getGroup_3(), "rule__EventModel__Group_3__0");
					put(grammarAccess.getGenericImportAccess().getGroup(), "rule__GenericImport__Group__0");
					put(grammarAccess.getQueryImportAccess().getGroup(), "rule__QueryImport__Group__0");
					...
					put(grammarAccess.getAtomicEventPatternAccess().getGroup_2(), "rule__AtomicEventPattern__Group_2__0");
					put(grammarAccess.getAtomicEventPatternAccess().getGroup_3(), "rule__AtomicEventPattern__Group_3__0");
					put(grammarAccess.getAtomicEventPatternAccess().getGroup_4(), "rule__AtomicEventPattern__Group_4__0");
					put(grammarAccess.getAtomicEventPatternAccess().getGroup_4_1(), "rule__AtomicEventPattern__Group_4_1__0");
					put(grammarAccess.getQueryResultChangeEventPatternAccess().getGroup(), "rule__QueryResultChangeEventPattern__Group__0");
					put(grammarAccess.getComplexEventPatternAccess().getGroup(), "rule__ComplexEventPattern__Group__0");
					put(grammarAccess.getComplexEventPatternAccess().getGroup_8(), "rule__ComplexEventPattern__Group_8__0");
					put(grammarAccess.getRuleAccess().getGroup(), "rule__Rule__Group__0");
					put(grammarAccess.getRuleAccess().getGroup_4(), "rule__Rule__Group_4__0");
					put(grammarAccess.getTraitListAccess().getGroup(), "rule__TraitList__Group__0");
					put(grammarAccess.getTraitListAccess().getGroup_2(), "rule__TraitList__Group_2__0");
					...
					put(grammarAccess.getTypedParameterWithDefaultValueAccess().getGroup(), "rule__TypedParameterWithDefaultValue__Group__0");
					put(grammarAccess.getTypedParameterWithDefaultValueAccess().getGroup_1(), "rule__TypedParameterWithDefaultValue__Group_1__0");
					put(grammarAccess.getTraitTypedParameterListAccess().getGroup(), "rule__TraitTypedParameterList__Group__0");
					put(grammarAccess.getTraitTypedParameterListAccess().getGroup_1(), "rule__TraitTypedParameterList__Group_1__0");
					put(grammarAccess.getParametrizedQueryReferenceAccess().getGroup(), "rule__ParametrizedQueryReference__Group__0");
					put(grammarAccess.getParametrizedQueryReferenceAccess().getGroup_1(), "rule__ParametrizedQueryReference__Group_1__0");
					put(grammarAccess.getComplexEventExpressionAccess().getGroup(), "rule__ComplexEventExpression__Group__0");
					put(grammarAccess.getComplexEventExpressionAccess().getGroup_1(), "rule__ComplexEventExpression__Group_1__0");
					put(grammarAccess.getChainedExpressionAccess().getGroup(), "rule__ChainedExpression__Group__0");
					put(grammarAccess.getNormalPrimaryAccess().getGroup_0(), "rule__NormalPrimary__Group_0__0");
					put(grammarAccess.getNormalPrimaryAccess().getGroup_1(), "rule__NormalPrimary__Group_1__0");
					put(grammarAccess.getNegatedPrimaryAccess().getGroup(), "rule__NegatedPrimary__Group__0");
					put(grammarAccess.getMultiplicityAccess().getGroup(), "rule__Multiplicity__Group__0");
					put(grammarAccess.getInfiniteAccess().getGroup(), "rule__Infinite__Group__0");
					...
					put(grammarAccess.getParameterizedPatternCallAccess().getGroup(), "rule__ParameterizedPatternCall__Group__0");
					put(grammarAccess.getParameterizedPatternCallAccess().getGroup_1(), "rule__ParameterizedPatternCall__Group_1__0");
					...
					put(grammarAccess.getFollowsOperatorAccess().getGroup(), "rule__FollowsOperator__Group__0");
					...
					put(grammarAccess.getUntilOperatorAccess().getGroup(), "rule__UntilOperator__Group__0");
					put(grammarAccess.getNegOperatorAccess().getGroup(), "rule__NegOperator__Group__0");
					...
					put(grammarAccess.getEventModelAccess().getNameAssignment_1(), "rule__EventModel__NameAssignment_1");
					put(grammarAccess.getEventModelAccess().getImportsAssignment_2(), "rule__EventModel__ImportsAssignment_2");
					put(grammarAccess.getEventModelAccess().getContextAssignment_3_1(), "rule__EventModel__ContextAssignment_3_1");
					put(grammarAccess.getEventModelAccess().getModelElementsAssignment_4(), "rule__EventModel__ModelElementsAssignment_4");
					put(grammarAccess.getGenericImportAccess().getImportedNamespaceAssignment_1(), "rule__GenericImport__ImportedNamespaceAssignment_1");
					put(grammarAccess.getQueryImportAccess().getImportedNamespaceAssignment_1(), "rule__QueryImport__ImportedNamespaceAssignment_1");
					put(grammarAccess.getTraitAccess().getNameAssignment_1(), "rule__Trait__NameAssignment_1");
					put(grammarAccess.getTraitAccess().getParametersAssignment_3(), "rule__Trait__ParametersAssignment_3");
					put(grammarAccess.getAtomicEventPatternAccess().getNameAssignment_1(), "rule__AtomicEventPattern__NameAssignment_1");
					put(grammarAccess.getAtomicEventPatternAccess().getParametersAssignment_2_1(), "rule__AtomicEventPattern__ParametersAssignment_2_1");
					put(grammarAccess.getAtomicEventPatternAccess().getTraitsAssignment_3_1(), "rule__AtomicEventPattern__TraitsAssignment_3_1");
					put(grammarAccess.getAtomicEventPatternAccess().getCheckExpressionAssignment_4_1_1(), "rule__AtomicEventPattern__CheckExpressionAssignment_4_1_1");
					put(grammarAccess.getQueryResultChangeEventPatternAccess().getNameAssignment_1(), "rule__QueryResultChangeEventPattern__NameAssignment_1");
					put(grammarAccess.getQueryResultChangeEventPatternAccess().getParametersAssignment_3(), "rule__QueryResultChangeEventPattern__ParametersAssignment_3");
					put(grammarAccess.getQueryResultChangeEventPatternAccess().getQueryReferenceAssignment_6(), "rule__QueryResultChangeEventPattern__QueryReferenceAssignment_6");
					put(grammarAccess.getQueryResultChangeEventPatternAccess().getResultChangeTypeAssignment_7(), "rule__QueryResultChangeEventPattern__ResultChangeTypeAssignment_7");
					...
					put(grammarAccess.getComplexEventPatternAccess().getComplexEventExpressionAssignment_7(), "rule__ComplexEventPattern__ComplexEventExpressionAssignment_7");
					put(grammarAccess.getComplexEventPatternAccess().getContextAssignment_8_1(), "rule__ComplexEventPattern__ContextAssignment_8_1");
					put(grammarAccess.getRuleAccess().getNameAssignment_1(), "rule__Rule__NameAssignment_1");
					put(grammarAccess.getRuleAccess().getEventPatternsAssignment_3(), "rule__Rule__EventPatternsAssignment_3");
					put(grammarAccess.getRuleAccess().getEventPatternsAssignment_4_1(), "rule__Rule__EventPatternsAssignment_4_1");
					put(grammarAccess.getRuleAccess().getActionAssignment_5(), "rule__Rule__ActionAssignment_5");
					put(grammarAccess.getTraitListAccess().getTraitsAssignment_1(), "rule__TraitList__TraitsAssignment_1");
					put(grammarAccess.getTraitListAccess().getTraitsAssignment_2_1(), "rule__TraitList__TraitsAssignment_2_1");
					...
					put(grammarAccess.getTypedParameterWithDefaultValueAccess().getTypedParameterAssignment_0(), "rule__TypedParameterWithDefaultValue__TypedParameterAssignment_0");
					put(grammarAccess.getTypedParameterWithDefaultValueAccess().getValueAssignment_1_1(), "rule__TypedParameterWithDefaultValue__ValueAssignment_1_1");
					put(grammarAccess.getTraitTypedParameterListAccess().getParametersAssignment_0(), "rule__TraitTypedParameterList__ParametersAssignment_0");
					put(grammarAccess.getTraitTypedParameterListAccess().getParametersAssignment_1_1(), "rule__TraitTypedParameterList__ParametersAssignment_1_1");
					put(grammarAccess.getParametrizedQueryReferenceAccess().getQueryAssignment_0(), "rule__ParametrizedQueryReference__QueryAssignment_0");
					put(grammarAccess.getParametrizedQueryReferenceAccess().getParameterListAssignment_1_1(), "rule__ParametrizedQueryReference__ParameterListAssignment_1_1");
					put(grammarAccess.getComplexEventExpressionAccess().getRightAssignment_1_1(), "rule__ComplexEventExpression__RightAssignment_1_1");
					put(grammarAccess.getChainedExpressionAccess().getOperatorAssignment_0(), "rule__ChainedExpression__OperatorAssignment_0");
					put(grammarAccess.getChainedExpressionAccess().getExpressionAssignment_1(), "rule__ChainedExpression__ExpressionAssignment_1");
					put(grammarAccess.getNormalPrimaryAccess().getMultiplicityAssignment_0_1(), "rule__NormalPrimary__MultiplicityAssignment_0_1");
					put(grammarAccess.getNormalPrimaryAccess().getTimewindowAssignment_0_2(), "rule__NormalPrimary__TimewindowAssignment_0_2");
					put(grammarAccess.getNormalPrimaryAccess().getMultiplicityAssignment_1_3(), "rule__NormalPrimary__MultiplicityAssignment_1_3");
					put(grammarAccess.getNormalPrimaryAccess().getTimewindowAssignment_1_4(), "rule__NormalPrimary__TimewindowAssignment_1_4");
					put(grammarAccess.getNegatedPrimaryAccess().getNegOperatorAssignment_0(), "rule__NegatedPrimary__NegOperatorAssignment_0");
					put(grammarAccess.getNegatedPrimaryAccess().getLeftAssignment_1(), "rule__NegatedPrimary__LeftAssignment_1");
					put(grammarAccess.getAtomAccess().getPatternCallAssignment(), "rule__Atom__PatternCallAssignment");
					put(grammarAccess.getMultiplicityAccess().getValueAssignment_2(), "rule__Multiplicity__ValueAssignment_2");
					put(grammarAccess.getTimewindowAccess().getLengthAssignment_1(), "rule__Timewindow__LengthAssignment_1");
					put(grammarAccess.getParameterizedPatternCallAccess().getEventPatternAssignment_0(), "rule__ParameterizedPatternCall__EventPatternAssignment_0");
					put(grammarAccess.getParameterizedPatternCallAccess().getParameterListAssignment_1_1(), "rule__ParameterizedPatternCall__ParameterListAssignment_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.viatra.cep.vepl.ui.contentassist.antlr.internal.InternalVeplParser typedParser = (org.eclipse.viatra.cep.vepl.ui.contentassist.antlr.internal.InternalVeplParser) parser;
