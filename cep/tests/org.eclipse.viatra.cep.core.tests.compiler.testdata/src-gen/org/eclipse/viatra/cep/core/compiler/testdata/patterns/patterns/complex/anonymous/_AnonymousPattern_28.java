...
public class _AnonymousPattern_28 extends ParameterizableComplexEventPattern {
  public _AnonymousPattern_28() {
    super();
    ...
    setId("org.eclipse.viatra.cep.core.compiler.testdata.patterns.patterns.complex.anonymous._anonymouspattern_28");setEventContext(EventContext.CHRONICLE);
  }
}
