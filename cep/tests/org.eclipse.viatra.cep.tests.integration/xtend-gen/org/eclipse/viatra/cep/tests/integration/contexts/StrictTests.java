...
public class StrictTests extends BaseIntegrationTest {
  @Before
  @Override
  public void setUp() {
    try {
      ...
      CEPEngine.CEPEngineBuilder _eventContext = _newEngine.eventContext(EventContext.STRICT_IMMEDIATE);
