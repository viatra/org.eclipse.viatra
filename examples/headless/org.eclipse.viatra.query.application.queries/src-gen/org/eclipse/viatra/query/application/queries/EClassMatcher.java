...
public class EClassMatcher extends BaseMatcher<EClassMatch> {
   ...
   * 
   */
  public static EClassMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public EClassMatcher(final ViatraQueryEngine engine) throws IncQueryException {
