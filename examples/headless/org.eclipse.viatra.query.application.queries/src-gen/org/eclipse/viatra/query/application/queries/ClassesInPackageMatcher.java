...
public class ClassesInPackageMatcher extends BaseMatcher<ClassesInPackageMatch> {
   ...
   * 
   */
  public static ClassesInPackageMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(ClassesInPackageMatcher.class);
   ...
   */
  @Deprecated
  public ClassesInPackageMatcher(final ViatraQueryEngine engine) throws IncQueryException {
