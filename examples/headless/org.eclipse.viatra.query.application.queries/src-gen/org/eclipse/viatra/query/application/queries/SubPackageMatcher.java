...
public class SubPackageMatcher extends BaseMatcher<SubPackageMatch> {
   ...
   * 
   */
  public static SubPackageMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(SubPackageMatcher.class);
   ...
   */
  @Deprecated
  public SubPackageMatcher(final ViatraQueryEngine engine) throws IncQueryException {
