...
import org.eclipse.viatra.query.application.common.IncQueryHeadlessAdvanced;
...
//		System.out.println(hla.executeDemo_GenericAPI(model, patternFQN));
		URI fileURI = URI.createPlatformPluginURI("headlessQueries.incquery/src/org/eclipse/viatra/query/application/queries/headlessQueries.eiq", false);
