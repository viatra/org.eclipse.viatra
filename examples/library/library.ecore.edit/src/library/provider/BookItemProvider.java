		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LibraryPackage.Literals.BOOK__WRITERS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCitationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Book_citations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Book_citations_feature", "_UI_Book_type"),
				 LibraryPackage.Literals.BOOK__CITATIONS,
				 true,
				 false,
				 true,
				 null,
