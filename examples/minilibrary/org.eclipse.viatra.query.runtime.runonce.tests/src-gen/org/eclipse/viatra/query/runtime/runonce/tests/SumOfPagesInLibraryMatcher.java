...
public class SumOfPagesInLibraryMatcher extends BaseMatcher<SumOfPagesInLibraryMatch> {
   ...
   * 
   */
  public static SumOfPagesInLibraryMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public SumOfPagesInLibraryMatcher(final ViatraQueryEngine engine) throws IncQueryException {
