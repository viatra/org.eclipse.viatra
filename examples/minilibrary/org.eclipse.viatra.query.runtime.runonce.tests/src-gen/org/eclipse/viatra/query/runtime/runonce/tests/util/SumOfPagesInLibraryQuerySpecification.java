...
public final class SumOfPagesInLibraryQuerySpecification extends BaseGeneratedEMFQuerySpecification<SumOfPagesInLibraryMatcher> {
  ...
  @Override
  protected SumOfPagesInLibraryMatcher instantiate(final ViatraQueryEngine engine) throws IncQueryException {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("library", "org.eclipse.viatra.examples.library.Library"),new PParameter("sumOfPages", "java.lang.Integer"));
    }
