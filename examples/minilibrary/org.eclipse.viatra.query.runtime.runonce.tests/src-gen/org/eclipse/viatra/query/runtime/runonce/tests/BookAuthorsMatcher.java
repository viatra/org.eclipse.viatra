...
public class BookAuthorsMatcher extends BaseMatcher<BookAuthorsMatch> {
   ...
   * 
   */
  public static BookAuthorsMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public BookAuthorsMatcher(final ViatraQueryEngine engine) throws IncQueryException {
