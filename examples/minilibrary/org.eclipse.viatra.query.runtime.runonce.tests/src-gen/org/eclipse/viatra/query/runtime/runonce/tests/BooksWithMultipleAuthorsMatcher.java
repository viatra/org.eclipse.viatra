...
public class BooksWithMultipleAuthorsMatcher extends BaseMatcher<BooksWithMultipleAuthorsMatch> {
   ...
   * 
   */
  public static BooksWithMultipleAuthorsMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public BooksWithMultipleAuthorsMatcher(final ViatraQueryEngine engine) throws IncQueryException {
