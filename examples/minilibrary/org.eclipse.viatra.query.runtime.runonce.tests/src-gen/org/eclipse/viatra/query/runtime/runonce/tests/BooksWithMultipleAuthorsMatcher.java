...
public class BooksWithMultipleAuthorsMatcher extends BaseMatcher<BooksWithMultipleAuthorsMatch> {
   ...
   */
  @Deprecated
  public BooksWithMultipleAuthorsMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public BooksWithMultipleAuthorsMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
