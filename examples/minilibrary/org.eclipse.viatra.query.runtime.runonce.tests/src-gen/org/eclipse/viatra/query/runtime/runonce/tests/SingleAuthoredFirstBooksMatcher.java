...
public class SingleAuthoredFirstBooksMatcher extends BaseMatcher<SingleAuthoredFirstBooksMatch> {
   ...
   * 
   */
  public static SingleAuthoredFirstBooksMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public SingleAuthoredFirstBooksMatcher(final ViatraQueryEngine engine) throws IncQueryException {
