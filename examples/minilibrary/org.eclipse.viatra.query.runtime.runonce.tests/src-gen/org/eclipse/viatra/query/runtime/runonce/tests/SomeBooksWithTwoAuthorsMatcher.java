...
public class SomeBooksWithTwoAuthorsMatcher extends BaseMatcher<SomeBooksWithTwoAuthorsMatch> {
   ...
   */
  @Deprecated
  public SomeBooksWithTwoAuthorsMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public SomeBooksWithTwoAuthorsMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
