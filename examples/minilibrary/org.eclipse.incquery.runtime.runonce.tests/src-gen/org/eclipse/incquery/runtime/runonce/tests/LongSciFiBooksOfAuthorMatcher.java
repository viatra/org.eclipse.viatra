...
public class LongSciFiBooksOfAuthorMatcher extends BaseMatcher<LongSciFiBooksOfAuthorMatch> {
   ...
   * 
   */
  public static LongSciFiBooksOfAuthorMatcher on(final IncQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public LongSciFiBooksOfAuthorMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public DeltaMonitor<LongSciFiBooksOfAuthorMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Writer pAuthor, final Book pBook) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pAuthor, pBook});
  }
  ...
  public Set<Writer> getAllValuesOfauthor(final Book pBook) {
    return rawAccumulateAllValuesOfauthor(new Object[]{null, pBook});
  }
  ...
  public Set<Book> getAllValuesOfbook(final Writer pAuthor) {
    return rawAccumulateAllValuesOfbook(new Object[]{pAuthor, null});
  }
