...
public class OperationPackageImpl extends EPackageImpl implements OperationPackage {
	...
	protected void createOrgAnnotations() {
		...
		addAnnotation
		  (getChecklistEntry_Task(), 
		   source, 
		   new String[] {
			 "patternFQN", "operation.queries.ChecklistEntryTaskCorrespondence"
		   });		
		addAnnotation
		  (getChecklistEntry_Jobs(), 
		   source, 
		   new String[] {
			 "patternFQN", "operation.queries.ChecklistEntryJobCorrespondence"
		   });		
		addAnnotation
		  (getChecklist_Process(), 
		   source, 
		   new String[] {
			 "patternFQN", "operation.queries.ChecklistProcessCorrespondence"
		   });
	}
