...
public class InterfaceImpl extends ResourceElementImpl implements Interface {
	 ...
	 * @ordered
	 */
	protected EList<system.System> user;
	...
	public system.System getProvider() {
		...
		return (system.System)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public EList<system.System> getUser() {
		if (user == null) {
			user = new EObjectWithInverseResolvingEList.ManyInverse<system.System>(system.System.class, this, SystemPackage.INTERFACE__USER, SystemPackage.SYSTEM__USES);
		}
		return user;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SystemPackage.INTERFACE__USER:
				getUser().clear();
				getUser().addAll((Collection<? extends system.System>)newValue);
				return;
		}
