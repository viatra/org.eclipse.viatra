...
public class ActivityImpl extends ProcessElementImpl implements Activity {
	 ...
	 * @ordered
	 */
	protected EList<Activity> previous;
	...
	public EList<Activity> getNext() {
		if (next == null) {
			next = new EObjectWithInverseResolvingEList.ManyInverse<Activity>(Activity.class, this, ProcessPackage.ACTIVITY__NEXT, ProcessPackage.ACTIVITY__PREVIOUS);
		}
		return next;
	}
	 ...
	 * @generated
	 */
	public EList<Activity> getPrevious() {
		if (previous == null) {
			previous = new EObjectWithInverseResolvingEList.ManyInverse<Activity>(Activity.class, this, ProcessPackage.ACTIVITY__PREVIOUS, ProcessPackage.ACTIVITY__NEXT);
		}
		return previous;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ProcessPackage.ACTIVITY__PREVIOUS:
				getPrevious().clear();
				getPrevious().addAll((Collection<? extends Activity>)newValue);
				return;
		}
