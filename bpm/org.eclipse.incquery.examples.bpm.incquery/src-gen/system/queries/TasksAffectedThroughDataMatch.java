...
/**
 * Pattern-specific match representation of the system.queries.TasksAffectedThroughData pattern, 
 * to be used in conjunction with {@link TasksAffectedThroughDataMatcher}.
 * 
...
public abstract class TasksAffectedThroughDataMatch extends BasePatternMatch {
  ...
  public List<String> parameterNames() {
    return TasksAffectedThroughDataMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TasksAffectedThroughDataMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TasksAffectedThroughDataMatch other = (TasksAffectedThroughDataMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TasksAffectedThroughDataMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends TasksAffectedThroughDataMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends TasksAffectedThroughDataMatch {
