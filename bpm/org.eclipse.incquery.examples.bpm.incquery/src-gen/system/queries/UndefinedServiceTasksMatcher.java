...
/**
 * Generated pattern matcher API of the system.queries.UndefinedServiceTasks pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UndefinedServiceTasksMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * // second query (validation view)
 * {@literal @}Constraint(location = Task, message = "Service Task $Task.name$ has no job", severity = "warning")
...
public class UndefinedServiceTasksMatcher extends BaseMatcher<UndefinedServiceTasksMatch> {
   ...
   * 
   */
  public static UndefinedServiceTasksMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UndefinedServiceTasksMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UndefinedServiceTasksMatcher(engine);
   ...
   */
  @Deprecated
  public UndefinedServiceTasksMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UndefinedServiceTasksMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public DeltaMonitor<UndefinedServiceTasksMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Task pTask) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pTask});
  }
