...
public abstract class DataTaskReadCorrespondenceMatch extends BasePatternMatch {
  ...
  private DataTaskReadCorrespondenceMatch(final EObject pData, final EObject pTask) {
    this.fData = pData;
    this.fTask = pTask;
  }
   ...
   * 
   */
  public static DataTaskReadCorrespondenceMatch newMutableMatch(final EObject pData, final EObject pTask) {
   ...
   * 
   */
  public static DataTaskReadCorrespondenceMatch newMatch(final EObject pData, final EObject pTask) {
