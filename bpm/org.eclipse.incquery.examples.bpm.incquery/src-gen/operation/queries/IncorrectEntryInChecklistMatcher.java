...
public class IncorrectEntryInChecklistMatcher extends BaseMatcher<IncorrectEntryInChecklistMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<IncorrectEntryInChecklistMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final ChecklistEntry pChecklistEntry, final Task pTask, final process.Process pProcess) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pChecklistEntry, pTask, pProcess});
  }
  ...
  public Set<ChecklistEntry> getAllValuesOfChecklistEntry(final Task pTask, final process.Process pProcess) {
    return rawAccumulateAllValuesOfChecklistEntry(new Object[]{null, pTask, pProcess});
  }
  ...
  public Set<Task> getAllValuesOfTask(final ChecklistEntry pChecklistEntry, final process.Process pProcess) {
    return rawAccumulateAllValuesOfTask(new Object[]{pChecklistEntry, null, pProcess});
  }
  ...
  public Set<process.Process> getAllValuesOfProcess(final ChecklistEntry pChecklistEntry, final Task pTask) {
    return rawAccumulateAllValuesOfProcess(new Object[]{pChecklistEntry, pTask, null});
  }
