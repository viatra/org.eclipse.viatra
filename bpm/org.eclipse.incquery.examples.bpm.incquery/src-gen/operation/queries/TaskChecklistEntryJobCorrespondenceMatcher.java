 ...
 * 
 * <p>Matches of the pattern will be represented as {@link TaskChecklistEntryJobCorrespondenceMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * // hyper-edge (Task {@literal <}-- CheckListEntry --{@literal >} Job
...
public class TaskChecklistEntryJobCorrespondenceMatcher extends BaseMatcher<TaskChecklistEntryJobCorrespondenceMatch> {
   ...
   * 
   */
  public static TaskChecklistEntryJobCorrespondenceMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    TaskChecklistEntryJobCorrespondenceMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new TaskChecklistEntryJobCorrespondenceMatcher(engine);
   ...
   */
  @Deprecated
  public TaskChecklistEntryJobCorrespondenceMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public TaskChecklistEntryJobCorrespondenceMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  public TaskChecklistEntryJobCorrespondenceMatch newMatch(final Task pTask, final ChecklistEntry pCLE, final Job pJob) {
    return new TaskChecklistEntryJobCorrespondenceMatch.Immutable(pTask, pCLE, pJob);
