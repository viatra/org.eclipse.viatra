...
public class SystemImpl extends ResourceElementImpl implements system.System {
	...
	public EList<Interface> getProvides() {
		if (provides == null) {
			provides = new EObjectContainmentWithInverseEList<Interface>(Interface.class, this, SystemPackage.SYSTEM__PROVIDES, SystemPackage.INTERFACE__PROVIDER);
		}
		return provides;
	}
	...
	public EList<Interface> getUses() {
		if (uses == null) {
			uses = new EObjectWithInverseResolvingEList.ManyInverse<Interface>(Interface.class, this, SystemPackage.SYSTEM__USES, SystemPackage.INTERFACE__USER);
		}
		return uses;
	}
	 ...
	 * @generated
	 */
	public EList<Job> getContains() {
		if (contains == null) {
			contains = new EObjectContainmentEList<Job>(Job.class, this, SystemPackage.SYSTEM__CONTAINS);
		}
		return contains;
	}
	...
	public EList<Data> getData() {
		if (data == null) {
			data = new EObjectContainmentEList<Data>(Data.class, this, SystemPackage.SYSTEM__DATA);
		}
		return data;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SystemPackage.SYSTEM__CONTAINS:
				getContains().clear();
				getContains().addAll((Collection<? extends Job>)newValue);
				return;
			case SystemPackage.SYSTEM__DATA:
				getData().clear();
