    ...
    protected void createOrgAnnotations() {
        ...
        addAnnotation
          (getJob_Tasks(), 
           source, 
           new String[] {
             "patternFQN", "system.queries.JobTaskCorrespondence"
           });		
        addAnnotation
          (getJob_Info(), 
           source, 
           new String[] {
             "patternFQN", "system.queries.JobInfoCorrespondence"
           });		
        addAnnotation
          (getData_WritingTask(), 
           source, 
           new String[] {
             "patternFQN", "system.queries.DataTaskWriteCorrespondence"
           });		
        addAnnotation
          (getData_ReadingTask(), 
           source, 
           new String[] {
             "patternFQN", "system.queries.DataTaskReadCorrespondence"
           });
    }
