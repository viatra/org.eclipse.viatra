...
public interface Job extends ResourceElement {
	 ...
	 *        annotation="org.eclipse.incquery.querybasedfeature patternFQN='system.queries.JobTaskCorrespondence'"
	 * @generated
	 */
	EList<Task> getTasks();
	 ...
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="org.eclipse.incquery.querybasedfeature patternFQN='system.queries.JobInfoCorrespondence'"
	 * @generated
	 */
	EList<RuntimeInformation> getInfo();
