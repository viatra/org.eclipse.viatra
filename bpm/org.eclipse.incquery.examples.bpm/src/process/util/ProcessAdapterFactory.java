...
public class ProcessAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProcessSwitch modelSwitch =
		new ProcessSwitch() {
			...
			public Object caseProcess(process.Process object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link process.Task <em>Task</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link process.ProcessElement <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link process.Gateway <em>Gateway</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
