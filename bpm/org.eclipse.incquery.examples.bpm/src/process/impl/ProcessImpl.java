...
public class ProcessImpl extends ProcessElementImpl implements process.Process {
	 ...
	 * @ordered
	 */
	protected EList<Activity> contents;
	 ...
	 * @generated
	 */
	public EList<Activity> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentWithInverseEList<Activity>(Activity.class, this, ProcessPackage.PROCESS__CONTENTS, ProcessPackage.ACTIVITY__PARENT);
		}
		return contents;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ProcessPackage.PROCESS__CONTENTS:
				getContents().clear();
				getContents().addAll((Collection<? extends Activity>)newValue);
				return;
		}
