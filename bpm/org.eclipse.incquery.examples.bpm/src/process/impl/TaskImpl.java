 ...
 * <ul>
 *   <li>{@link process.impl.TaskImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaskImpl extends ActivityImpl implements Task {
	 ...
	 * @ordered
	 */
	protected static final TaskKind KIND_EDEFAULT = TaskKind.USER_LITERAL;
	...
	public void setKind(TaskKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessPackage.TASK__KIND:
				return getKind();
		}
