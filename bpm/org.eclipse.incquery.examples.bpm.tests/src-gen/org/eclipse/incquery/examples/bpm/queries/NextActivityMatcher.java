...
/**
 * Generated pattern matcher API of the org.eclipse.incquery.examples.bpm.queries.nextActivity pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link NextActivityMatch}.
 * 
 * <p>Original source:
 * <code><pre>
...
public class NextActivityMatcher extends BaseMatcher<NextActivityMatch> {
   ...
   * 
   */
  public static NextActivityMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    NextActivityMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new NextActivityMatcher(engine);
   ...
   */
  @Deprecated
  public NextActivityMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public NextActivityMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a NextActivityMatch object.
   * 
   */
  public Collection<NextActivityMatch> getAllMatches(final Activity pAct, final Activity pNext) {
    return rawGetAllMatches(new Object[]{pAct, pNext});
  }
   ...
   * @param pAct the fixed value of pattern parameter Act, or null if not bound.
   * @param pNext the fixed value of pattern parameter Next, or null if not bound.
   * @return a match represented as a NextActivityMatch object, or null if no match is found.
   * 
   */
  public NextActivityMatch getOneArbitraryMatch(final Activity pAct, final Activity pNext) {
    return rawGetOneArbitraryMatch(new Object[]{pAct, pNext});
  }
   ...
   * 
   */
  public boolean hasMatch(final Activity pAct, final Activity pNext) {
    return rawHasMatch(new Object[]{pAct, pNext});
  }
   ...
   * 
   */
  public int countMatches(final Activity pAct, final Activity pNext) {
    return rawCountMatches(new Object[]{pAct, pNext});
  }
   ...
   * 
   */
  public void forEachMatch(final Activity pAct, final Activity pNext, final IMatchProcessor<? super NextActivityMatch> processor) {
    rawForEachMatch(new Object[]{pAct, pNext}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Activity pAct, final Activity pNext, final IMatchProcessor<? super NextActivityMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pAct, pNext}, processor);
  }
   ...
   * 
   */
  protected Set<Activity> rawAccumulateAllValuesOfAct(final Object[] parameters) {
    Set<Activity> results = new HashSet<Activity>();
    rawAccumulateAllValues(POSITION_ACT, parameters, results);
    return results;
  }
  ...
  public Set<Activity> getAllValuesOfAct() {
    return rawAccumulateAllValuesOfAct(emptyArray());
  }
   ...
   * 
   */
  public Set<Activity> getAllValuesOfAct(final NextActivityMatch partialMatch) {
    return rawAccumulateAllValuesOfAct(partialMatch.toArray());
  }
   ...
   * 
   */
  protected Set<Activity> rawAccumulateAllValuesOfNext(final Object[] parameters) {
    Set<Activity> results = new HashSet<Activity>();
   ...
   * 
   */
  public Set<Activity> getAllValuesOfNext() {
   ...
   * 
   */
  public Set<Activity> getAllValuesOfNext(final NextActivityMatch partialMatch) {
