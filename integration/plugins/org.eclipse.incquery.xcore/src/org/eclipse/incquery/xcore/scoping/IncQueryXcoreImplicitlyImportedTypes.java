...
public class IncQueryXcoreImplicitlyImportedTypes extends ImplicitlyImportedFeatures
{
  @Inject
      ...
      cache.get
        ("extension.classes",
         ...
         new Provider<List<JvmType>>()
         {
           ...
           {
             return IncQueryXcoreImplicitlyImportedTypes.super.getExtensionClasses(context);
           }
         });
  }
      ...
      cache.get
        ("static.import.classes",
         ...
         new Provider<List<JvmType>>()
         {
           public List<JvmType> get()
           {
             return IncQueryXcoreImplicitlyImportedTypes.super.getStaticImportClasses(context);
           }
         });
  }
