...
public class ViatraQueryXcoreImplicitlyImportedTypes extends ImplicitlyImportedFeatures
{
  @Inject
      ...
      cache.get
        ("extension.classes",
         ...
         new Provider<List<JvmType>>()
         {
           ...
           {
             return ViatraQueryXcoreImplicitlyImportedTypes.super.getExtensionClasses(context);
           }
         });
  }
      ...
      cache.get
        ("static.import.classes",
         ...
         new Provider<List<JvmType>>()
         {
           public List<JvmType> get()
           {
             return ViatraQueryXcoreImplicitlyImportedTypes.super.getStaticImportClasses(context);
           }
         });
  }
