...
class ViatraQueryXcoreGenModelBuilder extends XcoreGenModelBuilder {

	@Inject
	protected extension ViatraQueryXcoreMapper mapper
				...
				GenFeature: {
					...
					if (xFeature != null) {
						if (xFeature instanceof XViatraQueryDerivedFeature) {
							(xFeature as XViatraQueryDerivedFeature).mapping.genFeature = genElement
