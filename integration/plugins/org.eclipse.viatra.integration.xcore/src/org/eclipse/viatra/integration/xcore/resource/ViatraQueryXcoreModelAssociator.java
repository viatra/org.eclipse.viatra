 ...
 *******************************************************************************/
package org.eclipse.viatra.integration.xcore.resource;
...
import org.eclipse.viatra.integration.xcore.util.ViatraQueryXcoreEcoreBuilder;
import org.eclipse.viatra.integration.xcore.util.ViatraQueryXcoreGenModelBuilder;
import org.eclipse.xtext.resource.DerivedStateAwareResource;

import com.google.inject.Inject;
import com.google.inject.Provider;

public class ViatraQueryXcoreModelAssociator extends XcoreModelAssociator {

    @Inject
    private ViatraQueryXcoreGenModelBuilder genModelBuilder;

    @Inject
    private Provider<ViatraQueryXcoreEcoreBuilder> xcoreEcoreBuilderProvider;

    @Inject
    private ViatraQueryXcoreMapper mapper;

    public ViatraQueryXcoreModelAssociator() {
        super();
    ...
    public void installDerivedState(DerivedStateAwareResource resource, boolean preLinkingPhase)
    {
      if (resource.getParseResult() != null && resource.getParseResult().getRootASTElement() instanceof XPackage)
      {
        ...
        ViatraQueryXcoreEcoreBuilder xcoreEcoreBuilder = xcoreEcoreBuilderProvider.get();
