 ...
 * {@link ViatraQueryXcoreMapper}.
 * 
 * @author Tamas Szabo (itemis AG)
 * 
 */
@Singleton
public class ViatraQueryXcoreScopeProvider extends XcoreScopeProvider {
    ...
    public ViatraQueryXcoreScopeProvider() {
        super();
    ...
    public IScope getScope(EObject context, EReference reference) {
        if (reference == XcorePackage.Literals.XVIATRA_QUERY_DERIVED_FEATURE__PATTERN) {
