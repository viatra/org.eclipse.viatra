 ...
 *
 */
public class DummyDiagnosticDecorator extends CellLabelProvider implements ILabelDecorator {
	 /**
	   ...
	   */
	  public DummyDiagnosticDecorator(ResourceSet resourceSet, StructuredViewer viewer)
	  {
	    this.viewer = viewer;
	   ...
	   * Creates an instance that supports {@link LiveValidator live validation}.
	   */
	  public DummyDiagnosticDecorator(EditingDomain editingDomain, StructuredViewer viewer)
	  {
	   ...
	   */
	  public DummyDiagnosticDecorator(EditingDomain editingDomain, StructuredViewer viewer, IDialogSettings dialogSettings)
	  {
	    this.editingDomain = editingDomain;
	   ...
	   * Only decorations explicitly produced from {@link ValidateAction} or those {@link EditUIMarkerHelper#getMarkerDiagnostics(Object, org.eclipse.core.resources.IFile) derived from markers} are displayed.
	   */
	  public DummyDiagnosticDecorator(ResourceSet resourceSet, ExtendedPropertySheetPage propertySheetPage)
	  {
	    this.resourceSet = resourceSet;
	   ...
	   * Creates an instance that supports {@link LiveValidator live validation}.
	   */
	  public DummyDiagnosticDecorator(EditingDomain editingDomain, ExtendedPropertySheetPage propertySheetPage)
	  {
	   ...
	   * Creates an instance that supports {@link LiveValidator live validation} and supports {@link DiagnosticDecorator.LiveValidator.LiveValidationAction#LIVE_VALIDATOR_DIALOG_SETTINGS_KEY enablement} via {@link IDialogSettings dialog setting}.
	   */
	  public DummyDiagnosticDecorator(EditingDomain editingDomain, ExtendedPropertySheetPage propertySheetPage, IDialogSettings dialogSettings)
	  {
	    this.editingDomain = editingDomain;
	    this.resourceSet = editingDomain.getResourceSet();
	    this.propertySheetPage = propertySheetPage;
	  ...
	  protected LiveValidator getLiveValidator()
	  {
	    if (liveValidator == null && editingDomain != null)
	    {
	      ...
	      // TODO HACK liveValidator.register(this);
	    }
	  ...
	  public void dispose()
	  {
	    if (liveValidator != null)
	    {
	      // TODO HACK liveValidator.deregister(this);
	    }
