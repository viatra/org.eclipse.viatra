 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.query.testing.snapshot.impl.IncQuerySnapshotImpl#getMatchSetRecords <em>Match Set Records</em>}</li>
 *   <li>{@link org.eclipse.viatra.query.testing.snapshot.impl.IncQuerySnapshotImpl#getModelRoots <em>Model Roots</em>}</li>
 *   <li>{@link org.eclipse.viatra.query.testing.snapshot.impl.IncQuerySnapshotImpl#getInputSpecification <em>Input Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IncQuerySnapshotImpl extends MinimalEObjectImpl.Container implements IncQuerySnapshot {
	/**
	...
	protected EClass eStaticClass() {
		return SnapshotPackage.Literals.INC_QUERY_SNAPSHOT;
	}
	...
	public EList<MatchSetRecord> getMatchSetRecords() {
		if (matchSetRecords == null) {
			matchSetRecords = new EObjectContainmentEList<MatchSetRecord>(MatchSetRecord.class, this, SnapshotPackage.INC_QUERY_SNAPSHOT__MATCH_SET_RECORDS);
		}
	...
	public EList<EObject> getModelRoots() {
		if (modelRoots == null) {
			modelRoots = new EObjectResolvingEList<EObject>(EObject.class, this, SnapshotPackage.INC_QUERY_SNAPSHOT__MODEL_ROOTS);
		}
		return modelRoots;
	}
	...
	public void setInputSpecification(InputSpecification newInputSpecification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INC_QUERY_SNAPSHOT__INPUT_SPECIFICATION, oldInputSpecification, inputSpecification));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SnapshotPackage.INC_QUERY_SNAPSHOT__MATCH_SET_RECORDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SnapshotPackage.INC_QUERY_SNAPSHOT__MODEL_ROOTS:
				return getModelRoots();
			case SnapshotPackage.INC_QUERY_SNAPSHOT__INPUT_SPECIFICATION:
