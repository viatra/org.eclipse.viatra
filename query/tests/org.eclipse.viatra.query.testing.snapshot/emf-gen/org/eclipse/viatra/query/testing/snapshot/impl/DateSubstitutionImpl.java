 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.query.testing.snapshot.impl.DateSubstitutionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateSubstitutionImpl extends MatchSubstitutionRecordImpl implements DateSubstitution {
    ...
    protected EClass eStaticClass() {
        return SnapshotPackage.Literals.DATE_SUBSTITUTION;
    }
    ...
    public void setValue(Date newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.DATE_SUBSTITUTION__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SnapshotPackage.DATE_SUBSTITUTION__VALUE:
                return getValue();
        }
