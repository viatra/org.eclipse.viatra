...
/**
 * This is the item provider adapter for a {@link org.eclipse.viatra.query.testing.snapshot.IncQuerySnapshot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncQuerySnapshotItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SnapshotPackage.Literals.INC_QUERY_SNAPSHOT__MODEL_ROOTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SnapshotPackage.Literals.INC_QUERY_SNAPSHOT__INPUT_SPECIFICATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SnapshotPackage.Literals.INC_QUERY_SNAPSHOT__MATCH_SET_RECORDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SnapshotPackage.Literals.INC_QUERY_SNAPSHOT__MATCH_SET_RECORDS,
