...
/**
 * This is the item provider adapter for a {@link org.eclipse.viatra.query.testing.snapshot.LongSubstitution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LongSubstitutionItemProvider extends MatchSubstitutionRecordItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SnapshotPackage.Literals.LONG_SUBSTITUTION__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LongSubstitution.class)) {
			case SnapshotPackage.LONG_SUBSTITUTION__VALUE:
