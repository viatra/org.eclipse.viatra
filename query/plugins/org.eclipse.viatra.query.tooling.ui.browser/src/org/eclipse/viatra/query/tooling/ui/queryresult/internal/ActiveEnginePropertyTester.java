...
public class ActiveEnginePropertyTester extends PropertyTester {
    ...
    public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
        if (ACTIVE_ENGINE.equals(property) && receiver instanceof IViewPart) {
            if (receiver instanceof QueryResultView) {
                QueryResultView queryResultView = (QueryResultView) receiver;
                return queryResultView.hasActiveEngine();
            }
        }
        return false;
    }
