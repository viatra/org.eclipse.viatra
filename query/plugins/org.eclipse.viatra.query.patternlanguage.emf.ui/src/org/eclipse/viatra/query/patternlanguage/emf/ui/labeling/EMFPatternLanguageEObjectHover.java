...
public class EMFPatternLanguageEObjectHover extends XbaseDispatchingEObjectTextHover {
    ...
    private ImmutableSet<String> handledPackages = ImmutableSet.of(
            PatternLanguagePackage.eNS_URI,
            EMFPatternLanguagePackage.eNS_URI); 
    ...
    public Object getHoverInfo(EObject first, ITextViewer textViewer, IRegion hoverRegion) {
        if (handledPackages.contains(first.eClass().getEPackage().getNsURI())) {
