...
//        return result;
    ...
    public synchronized ProjectionIndexer accessProjectionIndexer(RecipeTraceInfo productionTrace, TupleMask mask) {
    	...
    	if (indexerTrace == null) {
    		final org.eclipse.viatra.query.runtime.rete.recipes.ProjectionIndexerRecipe projectionIndexerRecipe = 
    ...
    private Table<ReteNodeRecipe, TupleMask, org.eclipse.viatra.query.runtime.rete.recipes.ProjectionIndexerRecipe> resultSeedRecipes = HashBasedTable.create();
...
//    }
    ...
    RecipeTraceInfo accessActiveIndexer(RecipeTraceInfo inactiveIndexerRecipeTrace) {
    	...
    	final org.eclipse.viatra.query.runtime.rete.recipes.ProjectionIndexerRecipe inactiveIndexerRecipe = 
    			(org.eclipse.viatra.query.runtime.rete.recipes.ProjectionIndexerRecipe) inactiveIndexerRecipeTrace.getRecipe();
		...
		final org.eclipse.viatra.query.runtime.rete.recipes.ProjectionIndexerRecipe activeIndexerRecipe = 
