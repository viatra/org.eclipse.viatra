...
import org.eclipse.viatra.cep.core.compiler.testdata.patterns.patterns.complex.anonymous._AnonymousPattern_26;
...
public class NotOr_Pattern extends ParameterizableComplexEventPattern {
  public NotOr_Pattern() {
    ...
    setId("org.eclipse.viatra.cep.core.compiler.testdata.patterns.patterns.complex.notor_pattern");
  }
}
