...
import org.eclipse.viatra.cep.core.compiler.testdata.patterns.patterns.complex.anonymous._AnonymousPattern_29;
...
public class NotOrParams_Pattern extends ParameterizableComplexEventPattern {
  public NotOrParams_Pattern() {
    ...
    setId("org.eclipse.viatra.cep.core.compiler.testdata.patterns.patterns.complex.notorparams_pattern");
  }
}
