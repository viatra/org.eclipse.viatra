...
public class _AnonymousPattern_13 extends ParameterizableComplexEventPattern {
  public _AnonymousPattern_13() {
    super();
    ...
    setId("org.eclipse.viatra.cep.core.compiler.testdata.patterns.patterns.complex.anonymous._anonymouspattern_13");setEventContext(EventContext.CHRONICLE);
  }
}
