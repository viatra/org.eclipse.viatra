...
public class _AnonymousPattern_17 extends ParameterizableComplexEventPattern {
  public _AnonymousPattern_17() {
    super();
    ...
    setId("org.eclipse.viatra.cep.core.compiler.testdata.patterns.patterns.complex.anonymous._anonymouspattern_17");setEventContext(EventContext.CHRONICLE);
  }
}
