...
/**
 * Generated pattern matcher API of the org.eclipse.incquery.testing.queries.CorrespondingRecords pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link CorrespondingRecordsMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see CorrespondingRecordsQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class CorrespondingRecordsMatcher extends BaseMatcher<CorrespondingRecordsMatch> {
  /**
   * @return the singleton instance of the query specification of this pattern
   * @throws IncQueryException if the pattern definition could not be loaded
   * 
   */
  public static IQuerySpecification<CorrespondingRecordsMatcher> querySpecification() throws IncQueryException {
   ...
   * 
   */
  public static CorrespondingRecordsMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    CorrespondingRecordsMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new CorrespondingRecordsMatcher(engine);
   ...
   */
  @Deprecated
  public CorrespondingRecordsMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public CorrespondingRecordsMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * 
   */
  public CorrespondingRecordsMatch newMatch(final MatchRecord pRecord, final MatchRecord pCorrespondingRecord) {
    return new CorrespondingRecordsMatch.Immutable(pRecord, pCorrespondingRecord);
  ...
  @Override
  protected CorrespondingRecordsMatch tupleToMatch(final Tuple t) {
    try {
  ...
  @Override
  protected CorrespondingRecordsMatch arrayToMatch(final Object[] match) {
    try {
  ...
  @Override
  protected CorrespondingRecordsMatch arrayToMatchMutable(final Object[] match) {
    try {
