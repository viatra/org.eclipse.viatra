...
/**
 * Pattern-specific match representation of the org.eclipse.incquery.testing.queries.IncorrectSubstitution pattern,
 * to be used in conjunction with {@link IncorrectSubstitutionMatcher}.
 * 
...
public abstract class IncorrectSubstitutionMatch extends BasePatternMatch {
  ...
  private IncorrectSubstitutionMatch(final MatchRecord pRecord, final MatchRecord pCorrespondingRecord) {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof IncorrectSubstitutionMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
  ...
  @Override
  public IncorrectSubstitutionQuerySpecification specification() {
    try {
  ...
  @SuppressWarnings("all")
  static final class Mutable extends IncorrectSubstitutionMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends IncorrectSubstitutionMatch {
