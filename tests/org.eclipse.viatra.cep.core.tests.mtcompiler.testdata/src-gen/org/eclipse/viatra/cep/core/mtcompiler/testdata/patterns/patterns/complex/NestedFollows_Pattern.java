...
public class NestedFollows_Pattern extends ParameterizableComplexEventPattern {
  public NestedFollows_Pattern() {
    super();
    ...
    setId("org.eclipse.viatra.cep.core.mtcompiler.testdata.patterns.patterns.complex.nestedfollows_pattern");
  }
}
