...
import org.eclipse.viatra.cep.core.mtcompiler.testdata.patterns.patterns.complex.anonymous._AnonymousPattern_1;
...
public class MultiplicityOnAtomic_Pattern extends ParameterizableComplexEventPattern {
  public MultiplicityOnAtomic_Pattern() {
    ...
    setId("org.eclipse.viatra.cep.core.mtcompiler.testdata.patterns.patterns.complex.multiplicityonatomic_pattern");
  }
}
