...
import org.eclipse.viatra.cep.core.mtcompiler.testdata.patterns.patterns.complex.anonymous._AnonymousPattern_21;
...
public class NotFollows_Pattern extends ParameterizableComplexEventPattern {
  public NotFollows_Pattern() {
    ...
    setId("org.eclipse.viatra.cep.core.mtcompiler.testdata.patterns.patterns.complex.notfollows_pattern");
  }
}
